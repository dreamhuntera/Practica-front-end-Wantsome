...
//var3--Object literals //NOT FINISHED-or better said NOT WORKING

function getCarDescription(manufacturer) {
    
    var searchIn = {
        "Toyota": function () { return "Japan" },
        "Mercedes": function () { return "Germania" },
        "Dacia": function () { return "Romania" },
        "Skoda": function () { return "Cehia" },
        "Sangyong": function () { return "China" },
        "Renault": function () { return "Franta" },
        default: function () { return "Marca este necunoscuta" }
    };
    if (Object.keys(searchIn) !== manufacturer) {
        return (searchIn.default());
    } 

        return ("Marca " + manufacturer + " se produce in " + searchIn[manufacturer]());
    
};


console.log(getCarDescription("Dacia"));
